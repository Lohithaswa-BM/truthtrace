...
AIClassification = Literal["LIKELY_AI_GENERATED", "LIKELY_AUTHENTIC", "INCONCLUSIVE"]
...
class AIDetection(BaseModel):
    label: str                 # "AI Manipulated" (short display label, kept for compat)
    score: float               # 0..100
    severity: Severity = "high"
    data_source: DataSource = "demo"
    # Phase 5.4: real model-inference fields. `is_ml_based=False` means the
    # ML pipeline was unavailable/unsupported for this evidence and the
    # result is an honest fallback, NOT a disguised heuristic guess.
